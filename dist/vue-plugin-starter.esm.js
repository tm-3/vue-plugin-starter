...
function _applyDecoratedDescriptor(target, property, decorators, descriptor, context) {
  ...
  keys$1(descriptor).forEach(function (key) {
  ...
  if (desc.initializer === void 0) {
    defineProperty$1(target, property, desc);
...
var ComponentSample = (_dec = Prop(), Component(_class = (_class2 = (_temp =
/*#__PURE__*/
function (_Vue) {
  _inherits(ComponentSample, _Vue);
  ...
  function ComponentSample() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ComponentSample)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "someProp", _initializerWarningHelper(_descriptor, _assertThisInitialized(_this)));
...
}(Vue), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "someProp", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
...
/* script */
const __vue_script__ = ComponentSample;
